...
from app.server.pipeline.emitter_signals import emitter_signal_catalogue
...
@router.get("/emitter-signals")
def get_emitter_signals() -> dict:
    return emitter_signal_catalogue()
